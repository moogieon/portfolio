  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p w-font="leading-7" w-text="lg <lg:base">
            안녕하세요! Javascript의 재미를 추구하는
            <br />
            프론트엔드 개발자 이창묵입니다.
            <br /> React, React Native, Next.js를 사용한 Web / Mobile
            Application 개발을 하고 있습니다.
            <br /> 코드 한줄마다 이유가 있으려고 노력하고있습니다.
            <br /> 문법보다 동작원리를 이해하려고 노력하고 휴먼 에러를 최소로
            줄이려고 합니다.
            <br /> 현재 함수형 프로그래밍 큰 흥미를 가지고 있습니다.
            <br /> 도전, 성장에 목말라 있습니다!
            <br />
            늦었지만 단순한 취업이 목표가 아닌 누구보다 강한 개발에 대한
            관심으로 시작 했고,
            <br /> 전공생에 뒤쳐지기 않으려 아니 앞서가기 위해 늘 최선을
            다하려고 노력하고있습니다!!
          </p>
        </div>
        <div
        ...
        >
          <div className="speech-bubble2" w-text="[#686eff]">
            아니 이게 왜 안돼;
          </div>
          ...
          <div w-font="game">
            <p>
              <span w-text="[#686eff]">Email:</span> moogieon817@gmail.com
            </p>
            <p>Phon: 010-5007-7365</p>
